...
function path1A() {
  ...
  background(bg0);
   text("You checked around different sections of your power armour.  ", width / 2, height / 4);
      ...
      text("Account balance:200 dollars.", width / 2+270, height / 4-80);
}
...
function path3B() {
  ...
  text("Account balance:120 dollars.", width / 2+270, height / 4-80);
}
...
function path4B() {
  ...
  text("Options: \n1.Pull out your chainsword, fight it blade to blade! \n2. Use your plasma cannon, most efficient way to kill it!\n3. What about weapons in the ultramar DLC?", width / 2, height / 2 + 80);
  text("Account balance:200 dollars.", width / 2+270, height / 4-120);

}
function AD() {
  background(pw2);
  text("Your finger slipped and clicked on the ad.", width / 2, height / 4);
  text("It's okay to pay some little amount to this game, you think. ", width / 2, height / 4+40);
  text("But suddenly, you find out that the price is 230.", width / 2, height / 4 +80);
  text("It exceeds your current account balance.", width / 2, height / 2 + 120);
  text("Options: \n1.pay more money inside your account! \n2. I don't want to do this anymore", width / 2, height / 4+160);
...
function path4C() {
 ...
 text("In the main chamber, there stands several chaos space marine.", width / 2, height / 4);
  ...
  text("Traitors!You shouts angrily at those heavily-armored monsters.", width / 2, height / 4 + 200);
  text("Options: \n1.Get your chainswords out, let them suffer！ \n2. Use your plasma cannon, pierce through their armor!", width / 2, height / 4 + 240);
  text("Account balance:120 dollars.", width / 2+270, height / 4-120);
}
...
function path5A() {
  ...
  text("Account balance:150 dollars.", width / 2+270, height / 4-80);
...
function path5E() {
  ...
  text("Options: \n1.Take off your headphone. ", width / 2, height / 4 + 240);
  text("Account balance:40 dollars.", width / 2+270, height / 4-120);
}
...
function ED() {
  background(bg5);
  text("You actually want to pay more money.", width / 2, height / 2);
  text("But you really can't afford it anymore.", width / 2, height / 2+40);
  text("You have already spent too much in the game. ", width / 2, height / 2 + 80);
  text("You sit down, thinking in despair...", width / 2, height / 2 + 120);
  text("This is ending three. Press R to go back to the main menu", width / 2, height / 2 + 160);
...
function keyPressed() {
  if (gameState === "menu" && key === 'Enter') {
    ...
    else if (keyCode === 51) gameState = "AD";
  }
  else if (gameState === "path4C") {
